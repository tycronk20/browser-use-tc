...
- **1-1000**: Light thinking for moderate complexity
- **1000-5000**: Medium thinking for complex reasoning  
- **5000-24576**: Heavy thinking for detailed analysis
...
To configure thinking budget, edit your config file at `~/.config/browseruse/config.json`:
...
**CLI Usage:**
```bash
# Use thinking budget configured in config.json
browseruse --model gemini-2.5-flash-preview-04-17
```
